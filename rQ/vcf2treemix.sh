...
/home/knam/save/programs/plink1.9/plink --file $file --make-bed --out $file --allow-no-sex --allow-extra-chr 0
/home/knam/save/programs/plink1.9/plink --bfile $file --freq --missing --within $2 --out $file --allow-no-sex --allow-extra-chr 0

# zip it
gzip $file".frq.strat"

# create input file for Treemix
python2 /home/knam/work/Nlugens_GBS/Revision/TreeMix/script/rQ/plink2treemix.py $file".frq.strat.gz" $file".treemix.frq.gz"
