...
output='/home/knam/work/Nlugens_GBS/Revision/FST/Fst_alongGenome.pdf'

v=read.table('/home/knam/work/Nlugens_GBS/Revision/FST/bg.windowed.weir_untruncated.fst',header=T)
v$i=c(1:nrow(v))
